...
class DatePickerState extends State<DatePicker> {
  ...
  Future _sNotification(DateTime scheduledTime, int id) async {
    var androidDetails = new AndroidNotificationDetails(
        "1", "Demo", "DemoNotificationChannel",
    ...
    fltrNotification.zonedSchedule(
        counter, "Demo", alarms[id][4], st, generalNotificationDetails,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Demo Project'), actions: [
        IconButton(
      ...
      drawer: Drawer(
        child: ListView(
          ...
          children: <Widget>[
            DrawerHeader(
              child:
                  Text('This is the nav drawer ', style: TextStyle(color: Colors.white)),
              decoration: BoxDecoration(
                color: Colors.purple[900],
              ),
            ),
            ListTile(
              title: Text('Example nav item 1'),
              onTap: () {
